...
data_array = []
df = pd.read_csv('../../../Empirical/source/Evolve/miniphylotrees/CladeMultiGen.csv', header=None)
df = df.T
...
dfeveryten.to_csv('../../../Empirical/source/Evolve/miniphylotrees/TensCladeMultiGen.csv', header=False,
          index=False)