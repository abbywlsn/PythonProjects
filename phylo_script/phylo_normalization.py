...
with open('../../Empirical/source/Evolve/miniphylotrees/GenTrees/OrgDiversityGenotypePercentiles.csv', 'r', newline='') as csv_file:
    ...
    with open('../../Empirical/source/Evolve/miniphylotrees/GenTrees/OrgDiversityGenotypeNormalized.csv',
